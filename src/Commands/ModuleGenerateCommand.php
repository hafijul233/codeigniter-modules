...
namespace Hafijul233\CodeigniterModules\Commands;
 ...
 */
class ModuleGenerateCommand extends BaseCommand
{
    use GeneratorTrait;
     ...
     * @var string
     */
    protected $description = 'Generates a new module with files.';
     ...
     * @var string
     */
    protected $usage = 'module:name <name> [options]';
